*** File /home/andy/Code/2022/epmmm/lab1/build/../lab1.cpp:
                #include <iostream>
                #include <iomanip>
                #include <fstream>
                #include <string>
       ...
       ##### -> JInput::JInput(int argc, char const ** argv){
           ...
           3 -> int JInput::get_param(char const ** argv, int ind){
       ...
       ##### -> void JModel::init_heat_sources(){
         ...
         100 -> float JModel::predict_iteration(){
                    float delta = 0.0f;
...
Execution Summary:
   ...
   100.00   Percent of the file executed
     ...
     7.43   Average executions per line
